...
### 2, 上传到linux并解压
```
drwxrwxr-x 11 esyonghu eszu       229 8月  18 07:50 kibana-6.4.0-linux-x86_64
-rw-r--r--  1 root     root 187936225 8月  31 10:58 kibana-6.4.0-linux-x86_64.tar.gz
```
### 3, 进入kibana-6.4.0-linux-x86_64下的config目录，修改kibana.yml
```
[root@localhost kibana-6.4.0-linux-x86_64]# cd kibana-6.4.0-linux-x86_64/config/
[root@localhost config]# ll
总用量 8
-rw-r--r-- 1 esyonghu eszu 5089 8月  1807:26 kibana.yml
...
### 4, 需要配置的配置信息
```
server.port :"kibana所在端口"
server.host :"kibana所在ip"
elasticsearch.url :"http://elasticsearchip:port"
```
